                                ...
                                <div class="bg-white rounded-xl p-5 shadow-md border border-gray-100">
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                                        ...
                                        <div class="relative group">
                                            ...
                                            <div class="relative">
                                                <input type="text" id="communitySearch" placeholder="Topluluk adı, klasör veya üniversite ara..." oninput="if(typeof filterCommunities === 'function') filterCommunities();" onkeyup="if(typeof filterCommunities === 'function') filterCommunities();" class="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all bg-gray-50 hover:bg-white text-gray-800 placeholder-gray-400">
                                        ...
                                        <div class="relative group">
                                            ...
                                            <div class="relative">
                                                <input type="text" id="filterUniversity" placeholder="Üniversite adı ile ara..." oninput="if(typeof filterCommunities === 'function') filterCommunities();" onkeyup="if(typeof filterCommunities === 'function') filterCommunities();" class="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all bg-gray-50 hover:bg-white text-gray-800 placeholder-gray-400">
